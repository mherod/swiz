...
async function main(): Promise<void> {
  ...
  reason += `3. Switch tasks: ${skillAdvice("work-on-issue", "use the /work-on-issue skill to pick up another issue.", `run: git checkout ${defaultBranch} to return to the default branch.`)}\n`
