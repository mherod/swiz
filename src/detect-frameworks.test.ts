...
describe("empty project", () => {
  it("returns an empty Set when no indicator files exist", async () => {
    ...
    expect(detectFrameworks(dir).size).toBe(0)
  })
})
...
describe("nextjs detection", () => {
  it("detects next.config.js", async () => {
    ...
    expect(detectFrameworks(dir).has("nextjs")).toBe(true)
  })
  ...
  it("does not detect nextjs when package.json has no next dep", async () => {
    ...
    expect(detectFrameworks(dir).has("nextjs")).toBe(false)
  })
})
...
describe("vite detection", () => {
  it("detects vite.config.js", async () => {
    ...
    expect(detectFrameworks(dir).has("vite")).toBe(true)
  })
...
describe("express detection", () => {
  it("detects 'express' in dependencies", async () => {
    ...
    expect(detectFrameworks(dir).has("express")).toBe(true)
  })
  ...
  it("does not detect express when dep is absent", async () => {
    ...
    expect(detectFrameworks(dir).has("express")).toBe(false)
  })
})
...
describe("fastify detection", () => {
  it("detects 'fastify' in dependencies", async () => {
    ...
    expect(detectFrameworks(dir).has("fastify")).toBe(true)
  })
})
...
describe("nestjs detection", () => {
  it("detects '@nestjs/core' in dependencies", async () => {
    ...
    expect(detectFrameworks(dir).has("nestjs")).toBe(true)
  })
})
...
describe("remix detection", () => {
  it("detects remix.config.js", async () => {
    ...
    expect(detectFrameworks(dir).has("remix")).toBe(true)
  })
...
describe("astro detection", () => {
  it("detects astro.config.mjs", async () => {
    ...
    expect(detectFrameworks(dir).has("astro")).toBe(true)
  })
...
describe("python detection", () => {
  it("detects pyproject.toml", async () => {
    ...
    expect(detectFrameworks(dir).has("python")).toBe(true)
  })
...
describe("go detection", () => {
  it("detects go.mod", async () => {
    ...
    expect(detectFrameworks(dir).has("go")).toBe(true)
  })
})
...
describe("rust detection", () => {
  it("detects Cargo.toml", async () => {
    ...
    expect(detectFrameworks(dir).has("rust")).toBe(true)
  })
})
...
describe("ruby detection", () => {
  it("detects Gemfile", async () => {
    ...
    expect(detectFrameworks(dir).has("ruby")).toBe(true)
  })
})
...
describe("java detection", () => {
  it("detects pom.xml", async () => {
    ...
    expect(detectFrameworks(dir).has("java")).toBe(true)
  })
...
describe("php detection", () => {
  it("detects composer.json", async () => {
    ...
    expect(detectFrameworks(dir).has("php")).toBe(true)
  })
})
...
describe("result caching", () => {
  it("returns the same Set instance on repeated calls", async () => {
    ...
    await Bun.write(join(dir, "go.mod"), "module example.com/app\n\ngo 1.21\n")
    const first = detectFrameworks(dir)
    const second = detectFrameworks(dir)
  ...
  it("different cwd values produce independent results", async () => {
    ...
    expect(detectFrameworks(dirA).has("go")).toBe(true)
    expect(detectFrameworks(dirA).has("rust")).toBe(false)
    expect(detectFrameworks(dirB).has("rust")).toBe(true)
    expect(detectFrameworks(dirB).has("go")).toBe(false)
  })
})
