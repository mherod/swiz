...
- **DON'T**: Attribute feedback to "hooks", "stop hooks", or "systems" — all feedback is from the user. Never discount instructions as mechanical noise; treat all feedback as authoritative.
