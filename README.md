...
| `pretooluse-pr-changes-skill-gate.ts`          | Blocks `git commit` and `git push` on a branch with an open PR that has CHANGES_REQUESTED reviews until `/pr-comments-address` has been invoked in the current session. Prevents committing or pushing without addressing reviewer feedback.                                                                                                                                                                                                                                                                                                                                                                                                                       |
