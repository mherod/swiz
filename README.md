...
| `pretooluse-dirty-worktree-gate.ts`            | Reports dirty-worktree context during task updates, including when the configured dirty-file threshold is exceeded, without blocking task planning. Covers Claude `TaskUpdate` and Codex `update_plan`.                                                                                                                                                                                                                                                                                                                                                                                                          |
