...
| `stop-memory-update-reminder.ts` | Checks whether CLAUDE.md or MEMORY.md was recently updated. If not, blocks with a suggestion to reflect on session learnings and update memory. 10-minute cooldown prevents nagging. |
